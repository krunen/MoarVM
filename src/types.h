...
typedef union  MVMCArray MVMCArray;
typedef union  MVMCArrayBody MVMCArrayBody;
typedef union  MVMCFlexStruct MVMCFlexStruct;
typedef union  MVMCFlexStructBody MVMCFlexStructBody;
...
typedef union  MVMCPointer MVMCPointer;
typedef union  MVMCPointerBody MVMCPointerBody;
typedef union  MVMCScalar MVMCScalar;
typedef union  MVMCScalarBody MVMCScalarBody;
typedef struct MVMCScalarSpec MVMCScalarSpec;
typedef union  MVMCStruct MVMCStruct;
typedef union  MVMCStructBody MVMCStructBody;
typedef union  MVMCUnion MVMCUnion;
typedef union  MVMCUnionBody MVMCUnionBody;
